...
const datacor = database.ref("FCSEF/02_Monitoreo_Aula02/Aire/Corriente/-Corriente-");
...
const datapot = database.ref("FCSEF/02_Monitoreo_Aula02/Aire/Potencia/-Potencia-");
...
const datavol = database.ref("FCSEF/02_Monitoreo_Aula02/Aire/Voltaje/Voltaje");
...
function actualizarDatosMedidor() {
  ...
  const database = firebase.database();
  const medidorRef = database.ref("FCSEF/02_Monitoreo_Aula02/Aire/Potencia/-Potencia-");
...
// Configura la referencia a tu base de datos de Firebase Realtime para corriente
const datacor2 = database.ref("FCSEF/02_Monitoreo_Aula02/Enchufes/Corriente/-Corriente-");
...
// Configura la referencia a tu base de datos de Firebase Realtime para potencia
const datapot2 = database.ref("FCSEF/02_Monitoreo_Aula02/Enchufes/Potencia/-Potencia-");
...
// Configura la referencia a tu base de datos de Firebase Realtime para voltaje
const datavol2 = database.ref("FCSEF/02_Monitoreo_Aula02/Enchufes/Voltaje/Voltaje");
...
function actualizarDatosMedidor2() {
  // Configura la referencia a tu base de datos de Firebase Realtime para obtener los datos del medidor
  const medidorRef2 = database.ref("FCSEF/02_Monitoreo_Aula02/Enchufes/Potencia/-Potencia-");
...
// Configura la referencia a tu base de datos de Firebase Realtime para corriente
const datacor3 = database.ref("FCSEF/02_Monitoreo_Aula02/Luces/Corriente/-Corriente-");
...
// Configura la referencia a tu base de datos de Firebase Realtime para potencia
const datapot3 = database.ref("FCSEF/02_Monitoreo_Aula02/Luces/Potencia/-Potencia-");
...
// Configura la referencia a tu base de datos de Firebase Realtime para voltaje
const datavol3 = database.ref("FCSEF/02_Monitoreo_Aula02/Luces/Voltaje/Voltaje");
...
function actualizarDatosMedidor3() {
  // Configura la referencia a tu base de datos de Firebase Realtime para obtener los datos del medidor
  const medidorRef3 = database.ref("FCSEF/02_Monitoreo_Aula02/Luces/Potencia/-Potencia-");
