...
const datacor = database.ref("FCSEF/01_Monitoreo_Aula01/Aire/Corriente/-Corriente-");
...
const datapot = database.ref("FCSEF/01_Monitoreo_Aula01/Aire/Potencia/-Potencia-");
...
const datavol = database.ref("FCSEF/01_Monitoreo_Aula01/Aire/Voltaje/Voltaje");
...
function actualizarDatosMedidor() {
  ...
  const database = firebase.database();
  const medidorRef = database.ref("FCSEF/01_Monitoreo_Aula01/Aire/Potencia/-Potencia-");
...
// Configura la referencia a tu base de datos de Firebase Realtime para corriente
const datacor2 = database.ref("FCSEF/01_Monitoreo_Aula01/Enchufes/Corriente/-Corriente-");
...
// Configura la referencia a tu base de datos de Firebase Realtime para potencia
const datapot2 = database.ref("FCSEF/01_Monitoreo_Aula01/Enchufes/Potencia/-Potencia-");
...
// Configura la referencia a tu base de datos de Firebase Realtime para voltaje
const datavol2 = database.ref("FCSEF/01_Monitoreo_Aula01/Enchufes/Voltaje/Voltaje");
...
function actualizarDatosMedidor2() {
  // Configura la referencia a tu base de datos de Firebase Realtime para obtener los datos del medidor
  const medidorRef2 = database.ref("FCSEF/01_Monitoreo_Aula01/Enchufes/Potencia/-Potencia-");
...
// Configura la referencia a tu base de datos de Firebase Realtime para corriente
const datacor3 = database.ref("FCSEF/01_Monitoreo_Aula01/Luces/Corriente/-Corriente-");

// Escucha cambios en los datos de Firebase en tiempo real para corriente
datacor3.on("value", (snapshot) => {
  const data = snapshot.val();
  const tiempo = snapshot.key; // Utiliza la clave (tiempo) como etiqueta
  const corriente = data; // Los datos de corriente vienen directamente de Firebase
...
// Configura la referencia a tu base de datos de Firebase Realtime para potencia
const datapot3 = database.ref("FCSEF/01_Monitoreo_Aula01/Luces/Potencia/-Potencia-");
...
// Configura la referencia a tu base de datos de Firebase Realtime para voltaje
const datavol3 = database.ref("FCSEF/01_Monitoreo_Aula01/Luces/Voltaje/Voltaje");
...
function actualizarDatosMedidor3() {
  // Configura la referencia a tu base de datos de Firebase Realtime para obtener los datos del medidor
  const medidorRef3 = database.ref("FCSEF/01_Monitoreo_Aula01/Luces/Potencia/-Potencia-");
